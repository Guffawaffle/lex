...
2. **HTTP mode supports OAuth2/JWT** (recommended) and API keys (deprecated)
3. **No encryption** for database at rest (frames, refresh tokens stored in plaintext)
...
- ⚠️ Database at rest not encrypted (see issue #273 for encryption roadmap)
