...
import { LEX_BEGIN, LEX_END, wrapWithMarkers } from "../../../src/shared/instructions/markers.js";
...
describe("Projection Engine", () => {
  ...
  describe("Idempotent update", () => {
    it("should return skip action when content is unchanged", () => {
      ...
      // First, create the copilot file with the expected content using wrapWithMarkers
      const copilotPath = join(testDir, ".github", "copilot-instructions.md");
      const wrappedContent = wrapWithMarkers(canonicalContent) + "\n";
